    ...
    return (
        <>
            ...
            <main className="bg-violet-50" role="main">
                <section className="_hero-section relative px-8 py-10 md:py-0 min-h-[calc(100vh-80px)] flex justify-center">
                ...
                <section className="_clients-section mt-12 min-h-[calc(100vh-80px)] flex flex-col justify-center items-center">
                    <div className="container mx-auto max-w-[1300px]">
                        <div className="text-center">
                            <h3 className="text-xl md:text-2xl lg:text-3xl font-[600] mb-4 text-slate-700 leading-10">
                                Our clients who trust us!
                            </h3>
                        </div>
                        <div className="grid grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-10">
